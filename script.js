//#1 localhost:89787/uid/ten
let client  = AgoraRTC.createClient({mode:'rtc', codec:"vp8"})
// var path    = window.location.pathname;
// var uidd     = path.split('/')[0]; 
// var channell = path.split('/')[1];
//#2
let config = {
    appid:"8b6763929d054970846572ce786efe6f",
    token:"0068b6763929d054970846572ce786efe6fIADoUEFxWHj/Bxot+RWVW/o2oWl/MTQxlPFm6TduoZhbMTzYXFEAAAAAEAB/8F679ibXYQEAAQD2Jtdh",
    uid:null,
    channel:"SwingPCall",
}
